...
constructor(@Qualifier("caseNotesApiHealthWebClient") webClient: WebClient) : HealthCheck(webClient)

@Component
class CommunityApiHealth
constructor(@Qualifier("communityApiHealthWebClient") webClient: WebClient) : HealthCheck(webClient)
