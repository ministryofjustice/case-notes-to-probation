...
class JwtAuthHelper(private val keyPair: KeyPair) {
  ...
  fun setAuthorisation(user: String = "case-notes-to-probation-client", roles: List<String> = listOf()): (HttpHeaders) -> Unit {
    val token = createJwt(
      subject = user,
      scope = listOf("read"),
  ...
  internal fun createJwt(
    ...
    mutableMapOf<String, Any>()
      ...
      .also { it["client_id"] = "case-notes-to-probation-client" }
